    ...
    public class AdministratorController : Controller
    {
        ...
        public IActionResult Odobren(int id)
        {
            ...
            if(korisnik.Verifikovan == Zahtev.PROCESIRA_SE)
            {
                _userRepository.UpdateKorisnik(korisnik, "Verifikovan", Zahtev.PRIHVACEN.ToString());
                 //Promeni
                Message message = new Message(new string[] { "djordjelazarevic1997@gmail.com" }, "[Web 2] - Projekat", "Vas profil je verifikovan, mozete poceti sa radom!");
        ...
        public IActionResult Odbijen(int id)
        {
            ...
            if(korisnik.Verifikovan == Zahtev.PROCESIRA_SE)
            {
                ...
                //Promeni
                Message message = new Message(new string[] { "web2projekatDjordje@gmail.com" }, "[Web 2] - Projekat", "Vas nalog je odbijen od strane administratora, ne mozete koristiti usluge naseg sistema!");
                _emailSender.SendEmail(message);
